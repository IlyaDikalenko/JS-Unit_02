...
// программа видит 3 - как слово, в то время 5 - как число, все дело в кавычках
...
function t8() {
    ...
    document.querySelector('.out-8').innerHTML = inputIn;
}
...
function t9() {
    ...
    document.querySelector('.out-9').innerHTML = inputIn.value;
    inputIn.value = '';
}
...
function t10() {
    let inputIn = document.querySelector('.i-10').value;
    document.querySelector('.out-10').innerHTML = inputIn * 20;
}
...
function t11() {
    ...
    document.querySelector('.out-11').innerHTML = inputIn + 55;
}
...
function t12() {
    let inputIn1 = document.querySelector('.i-12-1').value;
    let inputIn2 = document.querySelector('.i-12-2').value;
    document.querySelector('.out-12').innerHTML = 'Hello ' + inputIn2 + ' ' + inputIn1;
}
...
function t13() {
    let inputIn1 = +document.querySelector('.i-13-1').value;
    let inputIn2 = +document.querySelector('.i-13-2').value;
    document.querySelector('.out-13').innerHTML = inputIn1 + inputIn2;
}
...
function t15() {
    ...
    inputIn.style.border = "4px solid red";
}
...
function t16() {
    let inputIn1 = document.querySelector('.i-16-1').value;
    let inputIn2 = document.querySelector('.i-16-2').value;
    document.querySelector('.out-16').innerHTML = inputIn1 + inputIn2; 
}
...
function t19() {
    let inputIn1 = document.querySelector('.i-19-1').value;
    let inputIn2 = document.querySelector('.i-19-2').value;
    let sum = parseFloat(inputIn1) + parseFloat(inputIn2);
